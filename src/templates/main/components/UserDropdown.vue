<template>
  <div class="btn-group d-flex">
    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
      <i class="d-inline d-lg-none fas fa-user fa-lg text-white tw-text-black-charleston-green" style="opacity: 0.75"></i>
      <i class="fa fa-angle-down ml-2 opacity-8 tw-text-black-charleston-green" style="color: white; cursor: pointer"></i>
    </a>
    <div
            ...
            <div class="widget-content p-0">
              <div class="widget-content-wrapper">
                <div class="widget-content-left pr-4">
                  <div class="widget-heading">{{fname}} {{lname}}</div>
